		...
		<div id="page-wrapper">
			<div class="row">
				<div class="col-md-12" style="max-width:638px">
					<h1 style="float:left">Novo <small>tratamento ...</small></h1>
					...
					<form action="" id="artigos" name="artigos" method="POST" enctype="multipart/form-data">
						<div class="row"> 
							<div class="col-md-6">
								...
								<label for="subtitulo">Ordem no menu: </label>
								<select name="subtitulo" id="subtitulo" class="form-control" required>
									<?php for ($i = 1; $i < 100; $i++) { ?>
						...
						<input type="hidden" name="conteudo_tipo" value="tratamentos">
						<input type="submit" name="novo_artigo" class="btn btn-success btn-lg btn-block" value="Adicionar tratamento">
					</form>
				</div>
			</div>
		</div>  
