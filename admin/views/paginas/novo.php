		...
		<div id="page-wrapper">
			<div class="row">
				<div class="col-md-12" style="max-width:638px">
					<h1 style="float:left">Nova <small>página ...</small></h1>
					...
					<form action="" id="artigos" name="artigos" method="POST" enctype="multipart/form-data">
						<div class="row">
							...
							<div class="col-md-6">
								...
								<input type="text" id="tags" name="categorias" class="form-control" required>

								<label for="arquivo" style="margin-top:34px">Imagem destacada: </label>
						...
						<input type="hidden" name="conteudo_tipo" value="paginas">
						<input type="submit" name="novo_artigo" class="btn btn-success btn-lg btn-block" value="Adicionar página">
					</form>
				</div>
			</div>
		</div>  
